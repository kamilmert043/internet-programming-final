...
if(!isset($_SESSION['userkullanici_mail'])){
	$mail=isset($_SESSION['userkullanici_mail']);
}
else{
					...
					<div class="col-md-8">
						<div class="pushright">
							<div class="top">
								...
								<?php }else{ ?>
									<a href="#" class="btn btn-default btn-dark">Hoşgeldin<span>----</span><?php echo $kullanicicek['kullanici_adsoyad']; ?></a> <?php } ?>
									<div class="regwrap">
										<div class="row">
											...
											<div class="col-md-6">
												...
												<p>
													Alışveriş Yapmak İçin Kayıt Olmanız Gerekli.
												</p>
				...
				<div class="navbar navbar-default navbar-static-top">
					<div class="container">
						...
						<div class="col-md-2 machart">
							<button id="popcart" class="btn btn-default btn-chart btn-sm "><span class="mychart">Sepet</span>|</button>
							<div class="popcart">
