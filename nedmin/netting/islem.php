...
if (isset($_POST['kullanicikaydet'])) {
	...
	if($kullanici_passwordone==$kullanici_passwordtwo){
		...
		if (strlen($kullanici_passwordone)>=6) {
			...
			if ($say == 0)
			{
				$password = sha1($kullanici_passwordone);
				$kullanici_yetki = 1;
				...
				if ($insert) {
					header("Location:../../index.php?durum=registerbasarili");
				}
...
if (isset($_POST['admingiris'])) {
	...
	$kullanici_password=sha1($_POST['kullanici_password']);
...
if (isset($_POST['kullanicisifreguncelle'])) {
	...
	$kullanici_password=sha1($kullanici_eskipassword);
