...
<div class="container">
	...
	<div class="row">
		<div class="col-md-9"><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="dt-img">
						...
						<a class="fancybox" href="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" data-fancybox-group="gallery" ><img src="<?php echo $urunfotocek['urunfoto_resimyol'] ?>" alt="" class="img-responsive"></a>
					</div>
			...
			<div class="tab-review">			<ul id="myTab" class="nav nav-tabs shop-tab">
