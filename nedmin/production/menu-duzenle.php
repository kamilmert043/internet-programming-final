...
<?php }
          ...
          <div class="x_content">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Sayfa Linki<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="menu_url" disabled="true" value=" <?php echo $_SERVER['HTTP_HOST'] ?>/sayfa-<?php echo seo($menucek['menu_seourl'])?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
